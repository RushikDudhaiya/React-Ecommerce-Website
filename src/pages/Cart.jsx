    ...
    <div className='mt-10 max-w-6xl mx-auto mb-5 px-4 md:px-0'>
      {
        cartItem.length > 0 ? (
            ...
            <div>
              <div className='mt-10'>
                {cartItem.map((item, id) => {
                  return (
                    <div key={id} className='bg-gray-100 p-5 rounded-md flex items-center justify-between mt-3'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 md:gap-20'>
                <div className='bg-gray-100 rounded-md p-7 m-4 space-y-2'>
                  ...
                  <div className='flex w-full gap-5'>
                    <div className='flex flex-col space-y-1 w-full'>
                      ...
                      <input defaultValue={location.state} type="text" placeholder='Enter your state' className='p-2 rounded-md w-full' />
                    </div>
                    <div className='flex flex-col space-y-1 w-full'>
                      <label htmlFor="">PostCode</label>
                      <input defaultValue={location.postcode} type="text" placeholder='Enter your postcode' className='p-2 rounded-md w-full' />
                    </div>
                  </div>
                  ...
                  <div className='flex w-full gap-5'>
                    <div className='flex flex-col space-y-1 w-full'>
                      ...
                      <input defaultValue={location.country} type="text" placeholder='Enter your country' className='p-2 rounded-md w-full' />
                    </div>
                    <div className='flex flex-col space-y-1 w-full'>
                ...
                <div className='bg-white border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max'>
                  ...
                  <div className='flex justify-between items-center'>
                    <h1 className='flex gap-1 items-center text-gray-700'>
                      <span><LucideNotebookText /></span> Item Total</h1>
                    <p>${totalPrice}</p>
                  </div>
                  <div className='flex justify-between items-center'>
                    <h1 className='flex gap-1 items-center text-gray-700'>
                      <span><MdDeliveryDining /></span>Delivery Charge</h1>
                  ...
                  <div>
                    ...
                    <div className='flex gap-3'>
                      <input type="text" placeholder='Enter code' className='p-2 rounded-md w-full border border-gray-200' />
                      <button className='bg-white text-black border border-gray-200 px-4 cursor-pointer py-1 rounded-md'>Apply Promo Code</button>
                    </div>
                  </div>
          ...
          (<div className='flex flex-col gap-3 justify-center items-center h-[600px]'>
            <h1 className='text-red-500/80 font-bold text-5xl text-muted'>Oh no! Your cart is empty
            </h1>
